...
pp=""
export root_name="${pp}tgadb" #name you give to your project in ecs env
export rootdns="aiqem.tech"

#
#---------------SSL Parameters------------------
# pregenerated ssl certificate path 
export s3certpath="s3://aiqem-team/ssl-certs/tgad"

# parameters in nginx.conf
export ssldnsname=tgadb.aiqem.tech #what is in letsencrypt/live/<ssldnsname>
export nginxservername=tgadb.aiqem.tech  #what is in nginx conf
