...
export repo_name="adtech.client.dashboard" #used to check out git repo
export repo_branch="main"

export root_name="client" #name you give to your project in ecs env
...
export s3certpath="s3://aiqem-team/ssl-certs/star"  #path to live/ folder 

# parameters in nginx.conf
export ssldnsname="star.aiqem.tech" #what is in letsencrypt/live/<ssldnsname>
...
export dns_ssl_list="star.${rootdns} report.${rootdns} client.${rootdns} dev-client.${rootdns}"  ##gen ssl 
...
export ecsTaskPortMapList=443  #all ports to expose
