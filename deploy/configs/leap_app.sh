...
export repo_name="tenx-jobs" #used to check out git repo
export repo_branch="prod"

export root_name="leap-app" #name you give to your project in ecs env
export rootdns=10academy.org

export dnsprefix="leap"  #used to create dns name
if [ "$ENV" == "dev" ]; then
