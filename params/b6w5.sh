...
# == control variables 
team="b6training"
iam_users="yididiya nardos anastasia mahlet azaria" #provide the iam ds user as array here
...
udcfile="b${batch}g${group}.txt" # comment out if you don't want to install compute packages
