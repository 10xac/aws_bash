...
name="de-experiment"  #it is also a tag
dns_namespace="jupyter.ubongo.com"
service="ec2"
...
# == control variables 
team="dsde-team"
iam_users="ephi azaria abel dibora" #provide the iam ds user as array here
...
udcfile="ubongo.txt" # comment out if you don't want to install compute packages
USERS_FILE="ubongo.txt"
