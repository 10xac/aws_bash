...
ST = California
L = Santa Clara
O = Tenacious Intelligience  ##Name
OU = Tenacious Intelligience ##Division
CN= *.gettenacious.com ## Use your domain
emailAddress = yabebal@gettenacious ## Use your email address
[v3_ca]
...
openssl x509 -req -in my-aws.csr -CA castore.pem -CAkey castore.key -CAcreateserial  -out my-aws-public.crt -days 3650
